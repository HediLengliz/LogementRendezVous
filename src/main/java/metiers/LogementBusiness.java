...
public class LogementBusiness {
    ...
    public Logement updateLogementref(int reference, Logement newLogement) {
        for (Logement logement : logements) {
            if (logement.getReference() == reference) {
                logement.setAdresse(newLogement.getAdresse());
                logement.setGouvernorat(newLogement.getGouvernorat());
                logement.setType(newLogement.getType());
                logement.setDescription(newLogement.getDescription());
                logement.setPrix(newLogement.getPrix());
                logement.setDelegation(newLogement.getDelegation());
                return logement;
            }
        }
        return null;
